...
class FoodProductsPage extends StatefulWidget {
  ...
  @override
  State<FoodProductsPage> createState() => _FoodProductsPageState();
}

class _FoodProductsPageState extends State<FoodProductsPage> {
  List orderedFoods = [];
  List<int> qty = [];
