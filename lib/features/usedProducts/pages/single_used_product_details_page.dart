...
class UsedProductProductDetailsPage extends StatefulWidget {
  ...
  const UsedProductProductDetailsPage({super.key,  this.productId,  this.shopId, this.link, this.subCategory});

  @override
  State<UsedProductProductDetailsPage> createState() => _UsedProductProductDetailsPageState();
}

class _UsedProductProductDetailsPageState extends State<UsedProductProductDetailsPage> {
...
Future<List<GetAllusedProducts>> fetchSingleUsedProduct( String productId) async {
  ...
  if (response.statusCode == 200) {
    ...
    return jsonResponse.map((json) => GetAllusedProducts.fromJson(json)).toList();
  } else {
...
futurefetchSingleUsedProduct =  fetchSingleUsedProduct( widget.productId.toString())  ;
