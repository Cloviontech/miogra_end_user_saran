                  ...
                  children: [
                    ...
                    GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return productBox(
                            path: getUsedProductsCategory[index].product.primaryImage,
                            pName: getUsedProductsCategory[index].product.name,
                            oldPrice: int.parse(getUsedProductsCategory[index].product.actualPrice),
                            newPrice: getUsedProductsCategory[index].product.sellingPrice!,
                            offer: int.parse(getUsedProductsCategory[index].product.discountPrice!),
                            ...
                            page: () {
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) =>
                                           UsedProductProductDetailsPage(productId: getUsedProductsCategory[index].product.productId,)));
                            });
                      },
                    ),
