  ...
  return  Column(
    children: [
      ...
      Row(
        ...
        children: [
          IconButton(onPressed: (){}, icon: const Icon(Icons.location_on_rounded,color: Colors.greenAccent,)),
      ...
      Container(
        ...
        child: const Text('1st  Floor, Sridattatrayaswamy Temp Complex, Gandhi Nagar , Bangalore , Karnataka ,  560009.',style: TextStyle(
          fontSize: 18
        ),),
      )
    ],
